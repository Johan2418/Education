    ...
    <div className="max-w-6xl mx-auto p-4 space-y-4">
      ...
      <div className="mt-2">
        <button
          ...
          className="inline-flex items-center gap-2 rounded-lg border border-indigo-200 bg-indigo-50 px-3 py-1.5 text-sm font-semibold text-indigo-700 hover:bg-indigo-100"
        >
